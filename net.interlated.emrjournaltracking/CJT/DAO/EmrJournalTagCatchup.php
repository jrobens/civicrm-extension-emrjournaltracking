...
class CJT_DAO_EmrJournalTagCatchup extends CRM_Core_DAO
{
     ...
     * @static
     */
    static $_tableName = 'civiemrjournal_catchup';
        ...
        if (!(self::$_fields)) {
            self::$_fields = array(
                ...
                'catchup_date' => array(
                    ...
                    'label' => ts('EMR Journal Catchup Date'),
                    'title' => ts('EMR Journal Catchup Date'),
                    'required' => TRUE,
                ),
                'count' => array(
                    'name' => 'count',
